-- =====================================================
-- LinkForge Database Setup Script
-- =====================================================
-- Run this script in your Supabase SQL Editor to set up
-- the database schema for the URL shortener dashboard.
-- =====================================================
...
DROP POLICY IF EXISTS "Public can read links by short code" ON public.links;
...
-- This is more restrictive but works alongside the public policy
-- Supabase will use the most permissive policy that matches
...
DROP POLICY IF EXISTS "Public can update click count" ON public.links;
